...
<head>
    ...
    <!-- External libraries -->
    <script src="<%=request.getContextPath() %>/viwer3d/jquery.min.js"></script><!-- jquery.js -->
    <script src="<%=request.getContextPath() %>/viwer3d/jquery-ui.min.js"></script> <!-- http://jqueryui.com/ -->
    ...
    <script>
        var docs =
            [{"path":"<%=request.getContextPath() %>/viwer3d/0/0.svf","name":"提篮拱桥1.3DS"}]
        ;

...
(function($) {
	...
	$.fn.Framer = function(settings) {
		settings = $.extend({
			...
			closeBtn: '<div class="close_btn"><span class="glyphicon glyphicon-remove small" aria-hidden="true"></span></div>',
			inner: {},
			//width: 640,
			//height: 100,
		...
		var setPosition = function() {
			FRM.box.css({
				top: Math.floor(($(window).height() - FRM.box.outerHeight()) * 0.3) + $(window).scrollTop(),

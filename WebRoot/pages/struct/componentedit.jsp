...
<title>构件管理 - 构件编辑</title>
</head>
<body>
	<div class="page-header">
		<ol class="breadcrumb">
			<li><a href="#"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> 首页</a></li>
			<li><a href="javascript:crumb('struct/componentlist');">构件管理</a></li>
			<li class="active">构件编辑</li>
		</ol>
	</div>
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">构件管理</div>
					<div class="panel-body">
						<form action="<%=path%>/struct/cpupdate" id="z_form" class="form-horizontal">
							<c:if test="${tag eq 1}">
								...
								<!-- 名称 -->
                                    <div class="form-group">
                                        <label for="hint-field" class="col-sm-2 control-label">
                                           	<font class="condition">*</font>构件名称
                                        </label>
                                        <div class="col-sm-4">
                                        ...
                                        <label class="col-sm-0 control-label">
                                           	<font class="explain">对构件的描述</font>
                                        </label>
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <label class="col-sm-0 control-label">
                                           	<font class="explain">说明构件所属评定系统</font>
                                        </label>
                                    </div>

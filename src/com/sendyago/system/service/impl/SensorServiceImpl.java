/* ==============================================================
 * $ID: SensorServiceImpl.java, v1.4 2016/4/28 14:57:18 zgx Exp $
...
public class SensorServiceImpl extends BaseServiceImpl implements SensorService {
	...
	public void update(LinkedHashMap<String, Object> params) throws Exception {
		...
		switch (flag) {
		case "insert":
			super.update(params, "SYSTEM_SENSOR_INSERT");
			break;
		case "update":
			super.update(params, "SYSTEM_SENSOR_UPDATE");
			break;
		case "delete":
			super.update(params, "SYSTEM_SENSOR_DELETE");
			break;
		}
	}
